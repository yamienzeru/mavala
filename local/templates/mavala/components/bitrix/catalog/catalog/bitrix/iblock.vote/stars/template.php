...
?>
<div class="rating bx_item_detail_rating">Рейтинг —
	...
	<span class="number" id="<?=$arJSParams["ratingId"]?>">(0)</span>
</div>
...
BX.ready(function(){
	...
	window.<?=$strObName?>.setValue("<?=$votesCount > 0 ? ($votesValue+($votesValue>3?1:2))*20 : 0?>");
